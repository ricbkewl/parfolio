...
Generated: 2026-09-01T13:03:03.411354+00:00
...
|---|---:|---:|
| `app_admins` | NO | `404` |
| `golfer_profiles` | NO | `404` |
| `golfer_club_distances` | NO | `404` |
| `shared_rounds` | NO | `404` |
| `round_players` | NO | `401` |
| `round_scores` | NO | `404` |
| `round_hole_stats` | NO | `404` |
| `round_messages` | NO | `404` |
| `hidden_round_history` | NO | `404` |
| `courses` | NO | `404` |
