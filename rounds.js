(() => {
  ...
  style.textContent = `
    ...
    .live-map-summary{right:max(60px,calc(env(safe-area-inset-right) + 60px));grid-template-columns:.5fr .86fr .5fr 1.14fr}.live-play-menu{position:absolute;z-index:25;top:max(8px,calc(env(safe-area-inset-top) + 4px));right:max(8px,env(safe-area-inset-right));display:flex;width:46px;height:60px;flex-direction:column;align-items:center;justify-content:center;gap:5px;border:1px solid rgba(255,255,255,.2);border-radius:14px;background:rgba(12,20,16,.48);box-shadow:0 8px 24px rgba(0,0,0,.3);backdrop-filter:blur(9px);cursor:pointer}.live-play-menu i{display:block;width:21px;height:2px;border-radius:2px;background:#fff}.live-yard-card em{width:100%;margin-top:5px;padding-top:5px;border-top:1px solid rgba(245,207,104,.72);color:#a9efc9;font-size:10px;font-style:normal;font-weight:850;text-align:center}.hole-flyover-card{position:absolute;z-index:45;left:50%;top:19%;min-width:190px;transform:translateX(-50%);padding:13px 18px 12px;border:1px solid rgba(255,255,255,.34);border-radius:18px;background:rgba(12,35,26,.72);color:#fff;text-align:center;box-shadow:0 10px 30px rgba(0,0,0,.22);backdrop-filter:blur(13px)}.hole-flyover-card small{display:block;color:#e8c66e;font-size:10px;font-weight:700;letter-spacing:.14em}.hole-flyover-card b{display:block;margin-top:2px;color:#fff;font-size:25px}.hole-flyover-card span{display:block;margin-top:4px;color:rgba(255,255,255,.86);font-size:13px}.hole-flyover-card button{margin-top:9px;min-height:32px;padding:0 13px;border:1px solid rgba(255,255,255,.42);border-radius:999px;background:rgba(255,255,255,.11);color:#fff}.live-shell-flying .hole-edge-arrow{pointer-events:none;opacity:.45}.live-scorecard-tab{position:absolute;z-index:25;left:39%;bottom:calc(60px + env(safe-area-inset-bottom));transform:translateX(-50%);min-width:88px;min-height:26px;border:1px solid rgba(224,189,102,.5);border-radius:9px;background:rgba(12,20,16,.82);color:#f5dfa8;font:inherit;font-size:10px;backdrop-filter:blur(10px)}.live-scorecard-sheet{position:absolute;z-index:60;inset:auto 0 0;max-height:76dvh;overflow:auto;padding:18px 16px calc(18px + env(safe-area-inset-bottom));border-radius:24px 24px 0 0;background:#0a2b20;color:#fff;box-shadow:0 -18px 55px rgba(0,0,0,.42)}.live-scorecard-sheet[hidden]{display:none}.live-scorecard-sheet header{display:flex;align-items:center;justify-content:space-between}.live-scorecard-sheet header button{width:38px;height:38px;border:0;border-radius:50%;background:rgba(255,255,255,.1);color:#fff;font-size:25px}.live-scorecard-grid{display:grid;grid-template-columns:repeat(6,1fr);gap:6px;margin-top:14px}.live-scorecard-grid div{padding:8px 3px;border:1px solid rgba(255,255,255,.13);border-radius:9px;text-align:center}.live-scorecard-grid small{display:block;color:#b9cec3;font-size:8px}.live-scorecard-grid b{color:#f5dfa8;font-size:17px}@media(prefers-reduced-motion:reduce){.hole-flyover-card{display:none}}
    .live-yard-card{display:none}
    .pf-play-menu-overlay{position:absolute;z-index:80;inset:0;display:flex;justify-content:flex-end;background:rgba(4,18,12,.48);backdrop-filter:blur(3px)}.pf-play-menu-overlay[hidden]{display:none}.pf-play-menu{display:flex;width:min(280px,76vw);height:100%;flex-direction:column;overflow:auto;padding:max(10px,env(safe-area-inset-top)) 9px max(12px,env(safe-area-inset-bottom));border-left:1px solid rgba(224,189,102,.25);background:radial-gradient(circle at 50% 0,rgba(213,175,83,.22),transparent 30%),linear-gradient(155deg,#123f2b,#071f18);color:#fff;box-shadow:-14px 0 45px rgba(0,0,0,.4)}.pf-play-menu header{display:flex;align-items:center;justify-content:space-between;padding:3px 4px 9px;border-bottom:1px solid rgba(255,255,255,.14)}.pf-play-menu header strong{color:#f5dfa8;font-family:Georgia,serif;font-size:21px}.pf-play-menu header button{width:39px;height:39px;border:0;border-radius:50%;background:rgba(255,255,255,.1);color:#fff;font-size:27px}.pf-play-menu>button,.pf-language-panel button{min-height:47px;padding:8px;border:0;border-bottom:1px solid rgba(255,255,255,.09);background:transparent;color:#fff;font:inherit;font-size:15px;text-align:left}.pf-play-menu>button span,.pf-language-panel button span{display:inline-block;width:29px;color:#e0bd66;text-align:center}.pf-play-menu>button small{display:block;margin:2px 0 0 33px;color:#aac4b7;font-size:10px}.pf-language-panel{display:grid}.pf-language-panel[hidden]{display:none}.pf-language-panel button{min-height:40px;padding-left:23px;font-size:13px}.pf-language-panel button.active{background:rgba(224,189,102,.18);color:#f5dfa8}.pf-code-panel{padding:14px;border:1px solid rgba(224,189,102,.3);border-radius:14px;background:rgba(255,255,255,.06);text-align:center}.pf-code-panel[hidden]{display:none}.pf-code-panel small{color:#aac4b7}.pf-code-panel b{display:block;margin:6px 0;color:#f5dfa8;font-size:26px;letter-spacing:.14em}.pf-round-qr{display:flex;justify-content:center;margin:10px auto;padding:9px;width:198px;min-height:198px;border-radius:8px;background:#fff}.pf-round-qr img,.pf-round-qr canvas{max-width:180px;height:auto!important}.pf-code-url{display:block;overflow-wrap:anywhere;color:#aac4b7;font-size:9px}.pf-code-actions{display:flex;gap:7px;margin-top:9px}.pf-code-actions button{flex:1;min-height:36px;border:1px solid rgba(245,207,104,.48);border-radius:9px;background:rgba(245,207,104,.12);color:#fff}
  ...
  async function loadClubBag(){
    if(!currentUser)return [];
    const {data,error}=await sb.from('clubs').select('club_name,carry_yards').eq('user_id',currentUser.id).eq('is_active',true);
    if(error)return [];
    return (data||[]).filter(club=>Number.isFinite(Number(club.carry_yards))&&Number(club.carry_yards)>0).map(club=>({name:club.club_name,carry:Number(club.carry_yards)}));
  }
  ...
  function finalHoleCamera(points,zoom){
    const yards=points.slice(1).reduce((sum,point,index)=>sum+yardsBetween(points[index],point),0);
    return {center:pointAlongRoute(points,.46)||points[0],zoom:Number(zoom)||17,heading:bearingBetween(points[0],points.at(-1)),tilt:67.5,yards};
  }
  ...
  async function openLiveRound(round){
    ...
    const [scores,clubBag] = await Promise.all([loadScores(round),loadClubBag()]);
    let holeIndex = 0;
    let map, gpsMarker, watchId, gpsPoint, activePoints=[], plannerMarker, plannerHitLine, plannerGoLine, plannerHitLabel, plannerGoLabel, flyoverFrame, cameraAuditToken=0, resizeTimer, viewportHandler;
    const plannerAims = {};
    let mapMarkers = [];
    ...
    open(`<div class="live-round-shell">
      ...
      <div class="live-yard-card live-to-hit"><b id="yardsToHit">—</b><small>TO HIT</small><em id="clubToHit">Set Clubs</em></div>
      <div class="live-yard-card live-to-go"><b id="yardsToGo">—</b><small>TO GO</small><em id="clubToGo">Set Clubs</em></div>
      ...
      <button class="live-scorecard-tab" type="button" id="liveScorecardTab">Scorecard</button><section class="live-scorecard-sheet" id="liveScorecardSheet" hidden><header><div><small>LIVE ROUND</small><h2>Scorecard</h2></div><button type="button" id="closeLiveScorecard">×</button></header><div class="live-scorecard-grid" id="liveScorecardGrid"></div></section>
      <p class="live-status-line" id="liveRoundStatus" aria-live="polite">Requesting your GPS location…</p>
      <div class="pf-play-menu-overlay" id="pfPlayMenuOverlay" hidden><nav class="pf-play-menu"><header><strong>ParFolio</strong><button type="button" id="closePfPlayMenu">×</button></header><button type="button" data-pf-menu="home"><span>⌂</span>Home</button><button type="button" data-pf-menu="tee"><span>⛳</span>Playing Tee<small>${esc(round?.playing_tee||'Not selected')}</small></button><button type="button" data-pf-menu="scorecard"><span>▦</span>Round / Scorecard</button><button type="button" data-pf-menu="code"><span>▣</span>Show Code / QR</button><div class="pf-code-panel" id="pfCodePanel" hidden><small>ROUND CODE</small><b>${esc(round?.round_code||'—')}</b><div class="pf-round-qr" id="pfRoundQr"></div><span class="pf-code-url" id="pfCodeUrl"></span><div class="pf-code-actions"><button type="button" id="copyPfCode">Copy Code</button><button type="button" id="sharePfRound">Share</button></div></div><button type="button" data-pf-menu="courses"><span>⌖</span>Courses / Players</button><button type="button" data-pf-menu="language"><span>◎</span>Language<small id="pfLanguageLabel">English</small></button><div class="pf-language-panel" id="pfLanguagePanel" hidden>${[['en','English'],['es','Español'],['zh','中文'],['id','Bahasa Indonesia'],['hi','हिन्दी'],['fr','Français']].map(([code,label])=>`<button type="button" data-language="${code}"><span>✓</span>${label}</button>`).join('')}</div><button type="button" data-pf-menu="account"><span>◎</span>My Account</button><button type="button" data-pf-menu="guide"><span>?</span>App Guide</button><button type="button" data-pf-menu="about"><span>PF</span>About ParFolio</button></nav></div>
    </div>`);
    ...
    const renderScore = () => {
      ...
      const grid=document.getElementById('liveScorecardGrid');if(grid)grid.innerHTML=Array.from({length:holeCount},(_,index)=>`<div><small>HOLE ${index+1}</small><b>${scores[index+1]||'–'}</b></div>`).join('');
    };
    ...
    const suggestedClub = (yards,allowDriver=true) => {
      const bag=clubBag.filter(club=>allowDriver||String(club.name).toLowerCase()!=='driver');
      if(!bag.length)return 'Set Clubs';
      return bag.reduce((best,club)=>Math.abs(club.carry-yards)<Math.abs(best.carry-yards)?club:best,bag[0]).name;
    };
    const plannerLabelIcon = (kind,yards,club) => {
      const label=kind==='hit'?'TO HIT':'TO GO',safeClub=esc(club).replace(/&[^;]+;/g,'').slice(0,18),safeYards=String(yards||'—').replace(/[^0-9—]/g,'');
      const svg=`<svg xmlns="http://www.w3.org/2000/svg" width="116" height="78" viewBox="0 0 116 78"><rect x="1" y="1" width="114" height="76" rx="12" fill="#0c1410" fill-opacity=".58" stroke="#ffffff" stroke-opacity=".2"/><text x="58" y="25" text-anchor="middle" fill="#f5cf68" font-family="Arial" font-size="22" font-weight="800">${safeYards}</text><text x="58" y="38" text-anchor="middle" fill="#fff" font-family="Arial" font-size="10">yd</text><text x="58" y="50" text-anchor="middle" fill="#e4eee9" font-family="Arial" font-size="7" font-weight="800">${label}</text><line x1="14" y1="57" x2="102" y2="57" stroke="#f5cf68" stroke-opacity=".72"/><text x="58" y="71" text-anchor="middle" fill="#a9efc9" font-family="Arial" font-size="11" font-weight="800">${safeClub}</text></svg>`;
      return {url:`data:image/svg+xml;charset=UTF-8,${encodeURIComponent(svg)}`,scaledSize:new google.maps.Size(116,78),anchor:new google.maps.Point(150,39)};
    };
    const updatePlanner = (points=activePoints) => {
      ...
      const remaining=[aim,points.at(-1)];
      ...
      const hitClub=suggestedClub(toHit,!gpsPoint||yardsBetween(gpsPoint,points[0])<60),goClub=suggestedClub(toGo,false);
      plannerHitLine?.setPath([origin,aim]); plannerGoLine?.setPath(remaining); plannerMarker?.setPosition(aim);
      plannerHitLabel?.setPosition(interpolate(origin,aim,.5));plannerHitLabel?.setIcon(plannerLabelIcon('hit',toHit,hitClub));
      if(remaining[1]){plannerGoLabel?.setVisible(true);plannerGoLabel?.setPosition(interpolate(remaining[0],remaining[1],.5));plannerGoLabel?.setIcon(plannerLabelIcon('go',toGo,goClub))}else plannerGoLabel?.setVisible(false);
      ...
      document.getElementById('clubToHit').textContent=hitClub;
      document.getElementById('clubToGo').textContent=goClub;
    };
    const installPlanner = points => {
      plannerMarker?.setMap(null); plannerHitLine?.setMap(null); plannerGoLine?.setMap(null);plannerHitLabel?.setMap(null);plannerGoLabel?.setMap(null);
      if (!points.length) return;
      const origin=gpsPoint||points[0], aim=plannerAims[holeIndex]||points[1]||points.at(-1);
      plannerHitLine=new google.maps.Polyline({map,path:[origin,aim],strokeColor:'#f5cf68',strokeWeight:2.25,strokeOpacity:1,zIndex:800});
      plannerGoLine=new google.maps.Polyline({map,path:[aim,points.at(-1)],strokeColor:'#f5dfa8',strokeWeight:2.25,strokeOpacity:0,zIndex:800,icons:[{icon:{path:'M 0,-1 0,1',strokeColor:'#f5dfa8',strokeOpacity:.95,strokeWeight:2.25,scale:2.2},offset:'0',repeat:'14px'}]});
      ...
      plannerHitLabel=new google.maps.Marker({map,position:interpolate(origin,aim,.5),clickable:false,optimized:false,zIndex:11,icon:plannerLabelIcon('hit','—','Set Clubs')});plannerGoLabel=new google.maps.Marker({map,position:aim,clickable:false,optimized:false,zIndex:11,icon:plannerLabelIcon('go','—','Set Clubs')});
    ...
    const onceMapIdle = (timeout=900) => new Promise(resolve=>{let done=false;const finish=()=>{if(done)return;done=true;resolve()};google.maps.event.addListenerOnce(map,'idle',finish);setTimeout(finish,timeout)});
    const routeInsideSafeFrame = points => new Promise(resolve=>{let done=false;const finish=value=>{if(done)return;done=true;resolve(value)},overlay=new google.maps.OverlayView();overlay.onAdd=()=>{};overlay.onRemove=()=>{};overlay.draw=()=>{const projection=overlay.getProjection(),div=map.getDiv();if(!projection||!div)return;const width=div.clientWidth,height=div.clientHeight;if(!width||!height){finish(false);return}const pixels=points.map(point=>projection.fromLatLngToContainerPixel(point)),tee=pixels[0],green=pixels.at(-1),vertical=tee&&green?tee.y-green.y:0,horizontal=tee&&green?Math.abs(tee.x-green.x):Infinity;const safe=vertical>Math.max(70,horizontal*.65)&&pixels.every(pixel=>{if(!pixel)return false;const rightEdge=pixel.y<285?width-112:width-48;return pixel.x>=48&&pixel.x<=rightEdge&&pixel.y>=142&&pixel.y<=height-104});overlay.setMap(null);finish(safe)};overlay.setMap(map);setTimeout(()=>{overlay.setMap(null);finish(false)},700)});
    const maximizeSafeRouteZoom = async (points,token) => {let zoom=Number(map.getZoom());if(!Number.isFinite(zoom))return;for(let index=0;index<9&&token===cameraAuditToken&&!await routeInsideSafeFrame(points);index++){zoom-=.18;map.setZoom(zoom);await onceMapIdle()}for(let index=0;index<9&&token===cameraAuditToken;index++){const prior=zoom,candidate=Math.min(21,prior+.12);map.setZoom(candidate);await onceMapIdle();if(!await routeInsideSafeFrame(points)){map.setZoom(prior);await onceMapIdle();break}zoom=candidate}};
    const landHoleCamera = async () => {
      if (!map || !activePoints.length) return;
      const token=++cameraAuditToken,camera=finalHoleCamera(activePoints,map.getZoom()),points=[...activePoints];
      try{map.moveCamera(camera)}catch{}
      await onceMapIdle();if(token!==cameraAuditToken)return;if(Number(map.getTilt?.()||0)<60||!Number.isFinite(Number(map.getHeading?.()))){try{map.moveCamera(camera)}catch{}await onceMapIdle()}await maximizeSafeRouteZoom(points,token);
    };
    const drawHole = (applyCamera=true) => {
      ...
      activePoints = points;
      stops.filter(stop=>stop.kind!=='aim').forEach(stop => addMarker(stop.point, stop.label, stop.kind));
      if (points.length) {
      ...
      document.getElementById('liveRoundStatus').textContent = points.length ? 'Drag the gold planner: solid to target, dotted direct to the green.' : 'This hole is awaiting approved GPS mapping in the shared library.';
      renderScore();
    };
    const runHoleFlyover = targetIndex => {
      ...
      const camera=finalHoleCamera(activePoints,map.getZoom());
      ...
      const started=performance.now(),cruiseZoom=clamp(camera.zoom-1.8,15.7,17.2),smooth=t=>{t=clamp(t,0,1);return t*t*t*(t*(t*6-15)+10)},heading=(a,b,t)=>{const delta=((b-a+540)%360)-180;return(a+delta*t+360)%360};
      const frame=now=>{const t=clamp((now-started)/4200,0,1);let center,zoom,tilt,direction;if(t<.18){const p=smooth(t/.18);center=startCenter;zoom=startZoom+(cruiseZoom-startZoom)*p;tilt=startTilt+(34-startTilt)*p;direction=heading(startHeading,camera.heading,p*.2)}else if(t<.70){const p=smooth((t-.18)/.52);center=interpolate(startCenter,camera.center,p);zoom=cruiseZoom;tilt=34;direction=heading(startHeading,camera.heading,.2+.8*p)}else if(t<.76){center=camera.center;zoom=cruiseZoom;tilt=34;direction=camera.heading}else{const p=smooth((t-.76)/.24);center=camera.center;zoom=cruiseZoom+(camera.zoom-cruiseZoom)*p;tilt=34+(camera.tilt-34)*p;direction=camera.heading}try{map.moveCamera({center,zoom,tilt,heading:direction})}catch{}if(t>=1){finish();return}flyoverFrame=requestAnimationFrame(frame)};flyoverFrame=requestAnimationFrame(frame);
    };

    try {
      await loadGoogleMaps();
      map = new google.maps.Map(document.getElementById('playMap'), { center:{lat:Number(payload?.lat)||37.5,lng:Number(payload?.lng)||-119.5}, zoom:17, mapTypeId:'satellite', renderingType:google.maps.RenderingType?.VECTOR, heading:0, tilt:67.5, disableDefaultUI:true, clickableIcons:false, gestureHandling:'greedy', headingInteractionEnabled:true, tiltInteractionEnabled:true, backgroundColor:'#173c2b' });
      viewportHandler=()=>{clearTimeout(resizeTimer);resizeTimer=setTimeout(()=>{google.maps.event.trigger(map,'resize');landHoleCamera()},260)};window.addEventListener('resize',viewportHandler);screen.orientation?.addEventListener?.('change',viewportHandler);
      runHoleFlyover(0);
    ...
    document.getElementById('liveScorecardTab').addEventListener('click', () => {renderScore();document.getElementById('liveScorecardSheet').hidden=false});
    document.getElementById('closeLiveScorecard').addEventListener('click', () => document.getElementById('liveScorecardSheet').hidden=true);
    const menuOverlay=document.getElementById('pfPlayMenuOverlay'),languagePanel=document.getElementById('pfLanguagePanel'),languageNames={en:'English',es:'Español',zh:'中文',id:'Bahasa Indonesia',hi:'हिन्दी',fr:'Français'},menuCopy={en:{home:'Home',tee:'Playing Tee',scorecard:'Round / Scorecard',code:'Show Code / QR',courses:'Courses / Players',language:'Language',account:'My Account',guide:'App Guide',about:'About ParFolio'},es:{home:'Inicio',tee:'Tee de juego',scorecard:'Ronda / Tarjeta',code:'Mostrar código / QR',courses:'Campos / Jugadores',language:'Idioma',account:'Mi cuenta',guide:'Guía',about:'Acerca de ParFolio'},zh:{home:'主页',tee:'发球台',scorecard:'球局 / 记分卡',code:'显示代码 / QR',courses:'球场 / 球员',language:'语言',account:'我的账户',guide:'应用指南',about:'关于 ParFolio'},id:{home:'Beranda',tee:'Tee Bermain',scorecard:'Ronde / Kartu Skor',code:'Tampilkan Kode / QR',courses:'Lapangan / Pemain',language:'Bahasa',account:'Akun Saya',guide:'Panduan Aplikasi',about:'Tentang ParFolio'},hi:{home:'होम',tee:'खेलने की टी',scorecard:'राउंड / स्कोरकार्ड',code:'कोड / QR दिखाएँ',courses:'कोर्स / खिलाड़ी',language:'भाषा',account:'मेरा खाता',guide:'ऐप गाइड',about:'ParFolio के बारे में'},fr:{home:'Accueil',tee:'Tee de départ',scorecard:'Partie / Carte',code:'Afficher code / QR',courses:'Parcours / Joueurs',language:'Langue',account:'Mon compte',guide:'Guide',about:'À propos de ParFolio'}};
    const roundJoinUrl=()=>{const url=new URL('./',location.href);url.search='';url.hash='';url.searchParams.set('round',round?.round_code||'');return url.href};
    let qrRendered=false;
    const renderRoundQr=()=>{if(qrRendered)return;qrRendered=true;const target=document.getElementById('pfRoundQr'),url=roundJoinUrl();document.getElementById('pfCodeUrl').textContent=url;if(window.QRCode)new QRCode(target,{text:url,width:180,height:180,colorDark:'#123f2b',colorLight:'#ffffff',correctLevel:QRCode.CorrectLevel.M});else target.innerHTML='<span style="color:#123f2b;font-size:12px">QR unavailable. Copy or share the join link.</span>'};
    const shareRound=async()=>{const url=roundJoinUrl(),text=`Join my ParFolio round. Code: ${round?.round_code||''}`;if(navigator.share){try{await navigator.share({title:'Join ParFolio Round',text,url});return}catch(error){if(error?.name==='AbortError')return}}try{await navigator.clipboard.writeText(url);document.getElementById('sharePfRound').textContent='Link Copied'}catch{prompt('Copy this ParFolio join link:',url)}};
    const setPlayLanguage=code=>{const safe=languageNames[code]?code:'en';localStorage.parfolioLanguage=safe;document.documentElement.lang=safe;document.getElementById('pfLanguageLabel').textContent=languageNames[safe];document.querySelectorAll('[data-language]').forEach(button=>button.classList.toggle('active',button.dataset.language===safe));document.querySelectorAll('[data-pf-menu]').forEach(button=>{const textNode=[...button.childNodes].find(node=>node.nodeType===Node.TEXT_NODE&&node.textContent.trim());if(textNode)textNode.nodeValue=menuCopy[safe][button.dataset.pfMenu]})};setPlayLanguage(localStorage.parfolioLanguage||'en');
    document.getElementById('liveMenuButton').addEventListener('click', () => menuOverlay.hidden=false);
    document.getElementById('closePfPlayMenu').addEventListener('click', () => menuOverlay.hidden=true);
    menuOverlay.addEventListener('click',event=>{if(event.target===menuOverlay)menuOverlay.hidden=true});
    document.querySelectorAll('[data-language]').forEach(button=>button.addEventListener('click',()=>setPlayLanguage(button.dataset.language)));
    document.querySelectorAll('[data-pf-menu]').forEach(button=>button.addEventListener('click',()=>{const action=button.dataset.pfMenu;if(action==='home'){dialog.close();return}if(action==='tee'){const tee=prompt('Playing Tee:',round?.playing_tee||'');if(tee){round.playing_tee=tee.trim();button.querySelector('small').textContent=round.playing_tee;drawHole(true)}return}if(action==='scorecard'){menuOverlay.hidden=true;renderScore();document.getElementById('liveScorecardSheet').hidden=false;return}if(action==='code'){const panel=document.getElementById('pfCodePanel');panel.hidden=!panel.hidden;if(!panel.hidden)renderRoundQr();return}if(action==='language'){languagePanel.hidden=!languagePanel.hidden;return}menuOverlay.hidden=true;dialog.close();if(action==='courses'){document.querySelector('[data-screen="courses"]')?.click();return}showContent(action==='account'?'profile':action)}));
    document.getElementById('copyPfCode').addEventListener('click',async()=>{await navigator.clipboard?.writeText(round?.round_code||'');document.getElementById('copyPfCode').textContent='Copied'});
    document.getElementById('sharePfRound').addEventListener('click',shareRound);
    ...
    dialog.addEventListener('close', () => { if (watchId !== undefined) navigator.geolocation.clearWatch(watchId); if(flyoverFrame)cancelAnimationFrame(flyoverFrame);if(viewportHandler){window.removeEventListener('resize',viewportHandler);screen.orientation?.removeEventListener?.('change',viewportHandler)} dialog.classList.remove('live-round-dialog'); }, {once:true});
  }
