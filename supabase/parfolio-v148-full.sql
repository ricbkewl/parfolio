...
-- Existing incompatible beta round_players data is preserved in a private legacy table.
-- Existing ParFolio beta profile, club-distance and admin-role data is preserved when compatible.

-- ---- Legacy ParFolio schema bridge ----
...
-- ---- Existing ParFolio beta account-data bridge ----
...
-- ---- ParFolio round/security hardening supplement ----
...
-- ---- ParFolio Realtime compatibility ----
